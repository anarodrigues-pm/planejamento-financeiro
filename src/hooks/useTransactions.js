...
const CLOSING_DAY = 25 // dia de fechamento da fatura
...
export function useTransactions() {
  ...
  // ---- RESUMO GERAL ----
  // Investimento NÃO afeta o saldo — é separado
  const summary = useMemo(() => {
    ...
    return {
      balance: totalIncome - totalExpense, // investimento não deduz do saldo!
      totalIncome,
      totalExpense,
      totalInvest,
    }
